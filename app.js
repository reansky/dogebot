...
(() => {
  ...
  if (marketCopy) marketCopy.textContent = '$DOGEBOT includes a clearly labeled TSLA market panel ($TSLA) on Robinhood Chain. Live price, market cap, liquidity, volume, and holder data are read-only public signals; no trades or buy recommendation are active.';
...
(() => {
  ...
  localAi = (question) => /price|market|token|contract|tsla/i.test(String(question || ''))
